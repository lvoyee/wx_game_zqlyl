 ...
 * @Description: 微信跳一跳
 */
public class TiaotiaoMain {
    private static final String IMAGE_PATH = "/Users/Administrator/Downloads/screenshot.png";
    private static final String IMAGE_OUT_PATH = "/Users/Administrator/Downloads/jump/screenshot_out";
    ...
    private static void swipeTime(long ms) {
        try {
            Runtime.getRuntime()
                    .exec("adb shell input swipe 400 400 600 600 " + ms);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private static void getScreenshot() {
        try {
            ...
            // 上传手机截图到电脑
            Runtime.getRuntime()
                    .exec("adb pull /sdcard/screenshot.png /Users/Administrator/Downloads/screenshot.png");
            Thread.sleep(1000);
